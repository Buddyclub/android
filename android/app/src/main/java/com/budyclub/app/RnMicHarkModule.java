...
public class RnMicHarkModule extends ReactContextBaseJavaModule {
    private static final String TAG = "RNmicHark";
    ...
    public RnMicHarkModule(ReactApplicationContext reactContext) {
        super(reactContext);
